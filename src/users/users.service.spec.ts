  ...
  beforeEach(async () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        ...
        // A CORREÇÃO ESTÁ AQUI: Injetamos mocks que não quebram o efeito cascata
  ...
  describe('Cenários Adicionais de Cobertura (Sucesso e Erro)', () => {
    ...
    describe('updatePortfolio', () => {
      it('deve atualizar o portfólio (Sucesso)', async () => {
        // Ajuste fino: adicionei firstName e lastName para o getPortfolio não reclamar na concatenação de strings
